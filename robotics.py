...
def turn_90_degrees_left():
    ...
    motor.run_to_rel_pos(position_sp=-450, speed_sp=200)  # Adjust speed and position for turning left
    motor1.run_to_rel_pos(position_sp=450, speed_sp=200)  # Adjust speed and position for turning left
    motor.wait_while('running')
    motor1.wait_while('running')

def move_forward_until_dark_surface():
    '''Move forward until detecting a dark surface underneath'''
    motor.run_forever(speed_sp=300)  # Adjust speed as needed
    motor1.run_forever(speed_sp=300)  # Adjust speed as needed
...
def rotate_90_degrees_left():
    ...
    motor.run_to_rel_pos(position_sp=-450, speed_sp=200)  # Adjust speed and position for rotating left
    motor1.run_to_rel_pos(position_sp=-450, speed_sp=200)  # Adjust speed and position for rotating left
    motor.wait_while('running')
    motor1.wait_while('running')
